...
Wired to use our Settings (from .env) for the database URL and our Base
...
# Set the sqlalchemy.url from our Settings (so .env drives migrations).
...
# Our model metadata — enables autogenerate.
